...
// `matchedRoutes(c)[i].handler` and transactionMiddleware below picks it up by
// identity — totally independent of the route's path, so renames and remounts
// carry the marker with them. `skipAuth` in ./auth works the same way.
