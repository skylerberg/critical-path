...
export const taskActivityKindSchema = type(
  "'created' | 'title_changed' | 'description_changed' | 'column_changed' | 'label_added' | 'label_removed' | 'assignee_added' | 'assignee_removed' | 'blocker_added' | 'blocker_removed' | 'archived' | 'restored'"
);
